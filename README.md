...
If you want to process a single sequence, yuc an bypass he wrapper and run the Nextflow pipeline directly. The pipeline's default parameters are set in the nextflow.config file, however, you can override any of the parameters using the -- flag.
```bash
